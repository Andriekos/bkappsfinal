package com.ndtv.bkreader_final.adapters;
...
import com.ndtv.bkreader_final.models.RSSFeed;
import com.ndtv.bkreader_final.utils.ConnectionDetector;
import com.ndtv.bkreader_final.utils.Constants;
import com.ndtv.bkreader_final.utils.NewsFeedParser;

import java.util.ArrayList;
import java.util.List;

public class TabsPagerAdapter extends PagerAdapter {
    String tabs[] = {"News","Investigasi","Olahraga","Politik","Pendidikan","Peristiwa","Suara Warga","Wisata", "Detik.com","DetikFinance",
    "DetikHot","DetikInet","DetikSport","DetikOto","DetikFood","DetikHealth","DetikWolipop","Viva.co.id","Viva Bisnis","Viva Nasional",
    "Viva Dunia","Viva Tekno","Viva Sport","Viva Oto","Viva Kosmo","Tribun News","Antara News","Tempo.co","Tabloid Pulsa","Selular.id", "GSM Arena","21Cineplex",
    };
    Activity activity;
