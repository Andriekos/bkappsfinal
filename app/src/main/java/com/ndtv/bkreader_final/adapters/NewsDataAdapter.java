...
/**
 * Created by Andr0Ek4 on 20-03-2016.
 */
...
import com.ndtv.bkreader_final.WebViewActivity;
...
public class NewsDataAdapter extends RecyclerView.Adapter<NewsDataAdapter.FeedListRowHolder> {
    ...
    public FeedListRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.cardview_row_image, null);
